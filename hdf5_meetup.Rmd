...
**HDFView** : un petit outil pour visualiser vos fichier h5 **sans R** ![alt text here](scrared.png)![alt text here](scrared.png)![alt text here](scrared.png)
...
```{r, eval=TRUE, include=TRUE, echo=TRUE, message=FALSE}
h5f <- H5Fopen("myhdf5file.h5") # Ouverture de la connection
# Accès aux objets
h5f$df ; h5f$foo$A[1:2,]
H5Fclose(h5f) # Fermeture la connection
```
...
```{r, eval=TRUE, include=TRUE, echo=TRUE, message=FALSE, results ='hide'}
h5createDataset(file = "myhdf5file.h5", dataset = "foo/H",dims = c(1000, 1000 , 100),
